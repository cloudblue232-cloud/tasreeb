...
export default function FloatingWhatsApp() {
  const link = whatsappLink('مرحباً، أودّ الاستفسار عن خدماتكم')
  ...
  return (
    ...
    >
      <div className="w-14 h-14 rounded-full bg-green-500 hover:bg-green-600 flex items-center justify-center shadow-2xl shadow-green-500/40 transition-colors">
